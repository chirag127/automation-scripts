...
def bd(promt):
    ...
    # payload example: {"fn_index":2,"data":["how to make a cake",32,"Sample","Sample 1"],"action":"predict","session_hash":"ar9htvvc59"}
    payload = {
        "fn_index": 2,
    ...
    # response example: {"hash":"662b265fb17649e691618cf9d452a769","queue_position":0}  # hash is the unique id for the prediction
